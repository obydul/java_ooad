...
public class FindGuitarTester {
    ...
    public static void main(String[] args) {
        ...
        List matchingGuitars = in.search(whatErinLikes);
    ...
    private static void initializeInventory(Inventory inventory) {
        inventory.addGuitar("123123", 110.50, Builder.COLLINGS,
                "CJ", Type.ACOUSTIC,
                Wood.BANGLADESHI_ROSEWOOD, Wood.SITKA);
        inventory.addGuitar("V95693", 449.50, Builder.FENDER,
                "Stratocastor", Type.ELECTRIC,
                Wood.ALDER, Wood.ALDER);
        inventory.addGuitar("V95512", 1549.50, Builder.FENDER,
                "Stratocastor", Type.ELECTRIC,
                Wood.ALDER, Wood.ALDER);
        ...
        inventory.addGuitar("1092", 12995.95, Builder.OLSON,
                "SJ", Type.ACOUSTIC,
                Wood.BANGLADESHI_ROSEWOOD, Wood.CEDAR);
